...
import { Code as Code2, ArrowLeft, Clock, Users, Star, Play, BookOpen, Trophy, Target, CheckCircle, Video, FileText, Award, Calendar } from 'lucide-react';
...
const coursesData = {
  '1': {
    ...
    color: "bg-pink-500",
    price: "₹5,000/month",
    description: "Learn programming concepts through fun visual blocks and create your own games and animations. Perfect for young learners starting their coding journey.",
    objectives: [
    ...
    curriculum: [
      { week: "1-2", title: "Introduction to Scratch", topics: ["Interface overview", "Basic blocks", "Sprites and costumes"] },
      { week: "3-4", title: "Motion and Looks", topics: ["Movement commands", "Coordinate system", "Costume changes"] },
      { week: "5-6", title: "Events and Control", topics: ["Event handlers", "Loops", "Conditions"] },
      { week: "7-8", title: "Variables and Lists", topics: ["Creating variables", "Score tracking", "Using lists"] },
      { week: "9-10", title: "Game Development", topics: ["Sprite interactions", "Collision detection", "Game logic"] },
      { week: "11-12", title: "Final Projects", topics: ["Project planning", "Implementation", "Presentation"] }
    ],
    projects: [
  ...
  '2': {
    ...
    color: "bg-blue-500",
    price: "₹5,500/month",
    description: "Advanced Scratch programming with complex logic, algorithms, and interactive projects designed for intermediate learners.",
    objectives: [
    ...
    curriculum: [
      { week: "1-2", title: "Advanced Scratch Techniques", topics: ["Custom blocks", "Cloning", "Advanced motion"] },
      { week: "3-4", title: "Algorithms Basics", topics: ["Sorting algorithms", "Search patterns", "Optimization"] },
      { week: "5-6", title: "Data Structures", topics: ["Lists and arrays", "Stack operations", "Queue implementation"] },
      { week: "7-8", title: "Game AI", topics: ["Enemy behavior", "Pathfinding", "Decision making"] },
      { week: "9-11", title: "Complex Projects", topics: ["Multi-level games", "Score systems", "Save/load features"] },
      { week: "12-14", title: "Capstone Project", topics: ["Project design", "Development", "Testing & deployment"] }
    ],
    projects: [
  ...
  '3': {
    ...
    color: "bg-green-500",
    price: "₹6,000/month",
    description: "Learn Python programming from basics to advanced concepts with real-world projects and professional coding practices.",
    objectives: [
    ...
    curriculum: [
      { week: "1-2", title: "Python Basics", topics: ["Variables & data types", "Operators", "Input/output"] },
      { week: "3-4", title: "Control Flow", topics: ["If-else", "Loops", "Functions"] },
      { week: "5-6", title: "Data Structures", topics: ["Lists", "Tuples", "Dictionaries", "Sets"] },
      { week: "7-8", title: "File Handling", topics: ["Reading files", "Writing files", "JSON data"] },
      { week: "9-10", title: "OOP Concepts", topics: ["Classes & objects", "Inheritance", "Polymorphism"] },
      { week: "11-12", title: "Libraries & Modules", topics: ["Standard library", "Third-party packages", "pip"] },
      { week: "13-16", title: "Projects", topics: ["Web scraping", "Data analysis", "Game development"] }
    ],
    projects: [
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Card className="p-8 bg-white shadow-2xl border-2 border-gray-100">
                <div className={`w-full h-48 ${course.color} bg-opacity-20 rounded-lg flex items-center justify-center mb-6`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {course.projects.map((project, index) => (
              <Card key={index} className="p-6 border-2 hover:border-orange-200 transition-all hover:shadow-lg">
                <div className="flex items-center space-x-4">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact">
                <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-orange-500 px-8 py-4 text-lg font-semibold">
                  Have Questions?
                </Button>
              </Link>
            </div>
