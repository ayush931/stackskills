    ...
    curriculum: [
      {
        ...
        topics: ['HTML structure', 'Semantic tags', 'Forms & validation'],
      },
      { week: '3-4', title: 'CSS Basics', topics: ['Selectors', 'Box model', 'Flexbox'] },
      {
        week: '5-6',
        title: 'Advanced CSS',
        topics: ['Grid layout', 'Animations', 'Responsive design'],
      },
      {
        week: '7-8',
      ...
      },
      {
        ...
        topics: ['ES6 features', 'Async programming', 'Fetch API'],
      },
      {
        week: '13-15',
        title: 'Web Projects',
        topics: ['Portfolio site', 'Interactive apps', 'Web games'],
      },
    ...
    curriculum: [
      {
        ...
        topics: ['Basic concepts', 'Components overview', 'Safety'],
      },
      {
        week: '3-4',
        title: 'Arduino Basics',
        topics: ['Arduino IDE', 'Digital I/O', 'Analog signals'],
      },
      {
        week: '5-6',
        title: 'Sensors',
        topics: ['Temperature sensors', 'Motion sensors', 'Light sensors'],
      },
      { week: '7-8', title: 'Actuators', topics: ['Motors', 'Servos', 'LEDs'] },
      {
        week: '9-10',
        title: 'IoT Basics',
        topics: ['Internet connectivity', 'Cloud platforms', 'Data logging'],
      },
      {
        week: '11-13',
        title: 'Robot Building',
        topics: ['Chassis design', 'Motor control', 'Navigation'],
      },
      {
        week: '14-16',
        title: 'Advanced Projects',
        topics: ['Smart home', 'Weather station', 'Line follower'],
      },
  ...
  '6': {
    ...
    curriculum: [
      ...
      },
      {
        ...
        topics: ['Supervised learning', 'Unsupervised learning', 'Training models'],
      },
      {
        week: '5-6',
        title: 'Neural Networks',
        topics: ['Perceptrons', 'Layers', 'Activation functions'],
      },
      {
        week: '7-8',
        title: 'Computer Vision',
        topics: ['Image recognition', 'Object detection', 'Teachable Machine'],
      },
      {
        week: '9-10',
        title: 'Natural Language',
        topics: ['Text classification', 'Sentiment analysis', 'Chatbots'],
      },
      {
        week: '11-12',
        title: 'ML Tools',
        topics: ['Scratch ML', 'TensorFlow Playground', 'Google Colab'],
      },
      {
        week: '13-14',
        title: 'AI Projects',
        topics: ['Face recognition', 'Voice commands', 'Game AI'],
      },
      {
        week: '15-16',
        title: 'Final Project',
        topics: ['AI app development', 'Testing', 'Presentation'],
      },
    ],
    projects: [
      'Chatbot Creation',
