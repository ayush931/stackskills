...
import { Code as Code2, ArrowLeft, Clock, Users, Star, Play, BookOpen, Trophy, Target, Cpu, Gamepad2, Globe, Brain, Zap, ChevronRight } from 'lucide-react';
...
const courses = [
  {
    ...
    color: "bg-pink-500",
    description: "Learn programming concepts through fun visual blocks and create your own games and animations.",
  ...
  },
  {
    ...
    color: "bg-blue-500",
    description: "Advanced Scratch programming with complex logic, algorithms, and interactive projects.",
  ...
  },
  {
    ...
    color: "bg-orange-500",
    description: "Explore robotics and Internet of Things with hands-on projects and real hardware.",
  ...
  },
  {
    ...
    color: "bg-red-500",
    description: "Introduction to artificial intelligence and machine learning concepts through fun projects.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover coding, STEM, and technology courses designed specifically for students from classes 4-10. 
              Start your journey into the world of programming and innovation!
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/about">
                <Button variant="outline" className="border-2 border-white text-black hover:bg-white hover:text-orange-500 px-8 py-3 text-lg font-semibold">
                  Learn More
                </Button>
              </Link>
            </div>
